...
public class LogicalTimeFactoryFactory {
	 ...
	 * name to createFederationExecution. If the supplied name is the empty
	 * string, the HLAfloat64TimeFactory is returned. If the supplied
	 * implementation name does not match any name supported by the library,
